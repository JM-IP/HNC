...
# parser.add_argument('--wbit', type=int, default=32, help='weights bits')
# parser.add_argument('--abit', type=int, default=32, help='activations bits')
...
parser.add_argument('--pretrain_init', action='store_true',
                    help='pretrain_init!!!.')
parser.add_argument('--quan_last_conv', default=True,
                    help='quan the last conv layer.')
...
parser.add_argument('--reg_weight', type=float, default=1,
                    help="the weights of reglazation loss by yip")
parser.add_argument('--var_weight', type=float, default=0,
                    help="the weights of var loss by yip")
parser.add_argument('--init_prune', type=float, default=0,
                    help="the init of prune threshold by yip")
parser.add_argument('--gradually', action='store_true',
                    help='whether prune step by step by yip.')
parser.add_argument('--cal_channel', type=str, default='sigmoid', choices=['sigmoid', 'sign'],
                    help='use sigmoid or sign to cal_channel')
